...
/** A abstract class to define all the Siege unit classes
 *
...
abstract class SiegeCards (protected val name:String,protected var strenght:Int,protected val ability:Int,protected val potition:2) extends Cards {
  ...
  /** gets the name of the Seige card
   *
   * @param void no parameters
   * @return the name of the Seige card
   * @example
   * {{{
  ...
  /** gets the strenght of the Seige card
   *
   * @param void no parameters
   * @return the Strenght of the Seige card
   * @example
   * {{{
   * for a card which extend from here named "a"
